    ...
    return (
        <div className="d-flex flex-column justify-content-center align-items-center text-white position-relative text-center bg-dark">
            <div className="position-relative d-inline-block image BoxWidth">
                <img className="img-fluid" src="/images/Scp.jpg" alt="scp" />
                <div className="fade"></div>
                <div className="position-absolute top-10 start-50 translate-middle text-white p-3 rounded">
                    <h2 class="ShadowOveride">Secure Contain Protect</h2>
...
The SCP universe has inspired numerous fan-made adaptations in varying forms of media, including literature, music, short films, and video games.
            ...
            <div className="border border-Secondary rounded p-3 m-3">
                <p class="BoxWidth"><strong>PLEASE BE REMINDED THAT ALL INFORMATION PERTAINING TO THE SCP FOUNDATION, ITS CONSTITUENTS, AND ITS MEMBERS IS STRICKLY PROHIBITED AND LEGALLY PUNISHABLE IF REVEALED TO THE GREATER PUBLIC.</strong></p>
            </div>
